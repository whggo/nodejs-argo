...
PORT="${SERVER_PORT:-${PORT:-9797}}"
UUID="${UUID:-133d8041-e8f3-4b60-b8ac-444e717f2551}"
NEZHA_SERVER="${NEZHA_SERVER:-}"
NEZHA_PORT="${NEZHA_PORT:-}"
NEZHA_KEY="${NEZHA_KEY:-}"
ARGO_DOMAIN="${ARGO_DOMAIN:-appwrite.777171.xyz}"
ARGO_AUTH="${ARGO_AUTH:-eyJhIjoiMTZjM2Q3ZWUyZjlmZmRiZmVlY2IzYTJlMThkMDE2ZjgiLCJ0IjoiZTI3YzI5MWUtMGNlZS00MTVjLWE1ZmEtMjllZjY4OGIzYzk3IiwicyI6Ik1UQmhNakl5WlRFdE1XWmpOaTAwTnprNUxUaGpPVEF0TVdJM05EWTVaRFkxWkRaaSJ9}"
